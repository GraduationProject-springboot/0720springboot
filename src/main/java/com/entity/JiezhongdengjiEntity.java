...
public class JiezhongdengjiEntity<T> implements Serializable {
	 ...
	 * 设置：接种单号
	 */
	public void setJiezhongdanhao(String jiezhongdanhao) {
		this.jiezhongdanhao = jiezhongdanhao;
	}
	/**
	 * 获取：接种单号
	 */
	public String getJiezhongdanhao() {
		return jiezhongdanhao;
	}
	/**
	 * 设置：疫苗名称
	 */
