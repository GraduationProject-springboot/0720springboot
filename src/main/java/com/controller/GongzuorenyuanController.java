...
public class GongzuorenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		GongzuorenyuanEntity user = gongzuorenyuanService.selectOne(new EntityWrapper<GongzuorenyuanEntity>().eq("renyuanzhanghao", username));
    ...
    public R register(@RequestBody GongzuorenyuanEntity gongzuorenyuan){
    	...
    	GongzuorenyuanEntity user = gongzuorenyuanService.selectOne(new EntityWrapper<GongzuorenyuanEntity>().eq("renyuanzhanghao", gongzuorenyuan.getRenyuanzhanghao()));
		if(user!=null) {
